...
public class Department
{
	...
	{
		return timeTable.getSlot(type, time);
	}
	...
	{
		return timeTable.getSlot(day, time, isLab);
	}
	...
	{
		return timeTable.getAllLectureSlots();
	}
	 ...
	 * @return All lab TimeSlots in the TimeTable as an ArrayList.
	 */
	public ArrayList<TimeSlot> getAllLabTimeSlots()
	{
		return timeTable.getAllLabSlots();
	}
	...
	{
		return courseTable.getAllLectures();
	}
	...
	{
		return courseTable.getAllCourses();
	}
	 ...
	 */
	public Assignments getPartialAssignments()
	{
		if (partialAssignments != null)
			return new Assignments(partialAssignments);
